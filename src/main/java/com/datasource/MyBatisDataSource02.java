...
@MapperScan(basePackages = "com.test02.mapper", sqlSessionFactoryRef = "test2SqlSessionFactory")
public class MyBatisDataSource02 {
	...
	public SqlSessionFactory testSqlSessionFactory(@Qualifier("test2DataSource") DataSource dataSource)
		...
		bean.setDataSource(dataSource);
		 ...
		 new
		 PathMatchingResourcePatternResolver().getResources("classpath:mapping2/*.xml"));
